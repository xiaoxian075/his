 ...
 * @time   2018年5月28日
 * 使用方法：IdUtil.getId();
 * 说明：因为js对整数的准确只能保证10进制下15个位数，所以对workerIdBits，datacenterIdBits，sequenceBits的支持位数做了缩短。
 *
...
//    }
    ...
    public static class SubClass{
        private static IdUtil cloudIdUtil = new IdUtil(0,0);
    }

    public static IdUtil getInstance(){
        return SubClass.cloudIdUtil;
    }
